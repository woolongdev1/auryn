...
In order to support loading of multiple wallets in auryn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is auryn.cpp.
...
Changes to auryn.cpp
----------------------
auryn.cpp is the entry point into auryn-qt, and as such, will require some minor modifications to provide hooks for
