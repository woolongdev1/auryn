...
This mechanism has been integrated into Bitcore-Node-auryn which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/auryn-Project/insight-api-auryn#web-socket-api](https://github.com/auryn-Project/insight-api-auryn#web-socket-api) 
* API: [https://github.com/auryn-Project/insight-api-auryn#swifttx-transactions](https://github.com/auryn-Project/insight-api-auryn#swifttx-transactions) 
...
By default, the auryn Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the auryn Core daemon:
