...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total AURN balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zAURNsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zAURN denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zAURN denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zAURN denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zAURN denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zAURN denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zAURN denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zAURN denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zAURN denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zAURN denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in AURN/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in AURN/kb\n"
    ...
    obj.push_back(Pair("zAURNsupply", zpivObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("validateaddress", "\"SPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\"") + HelpExampleRpc("validateaddress", "\"SPSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\""));
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            HelpExampleCli("createmultisig", "2 \"[\\\"S6sSauSf5pF2UkUwvKGq4qjNRzBZYqgEL5\\\",\\\"S71sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("createmultisig", "2, \"[\\\"S6sSauSf5pF2UkUwvKGq4qjNRzBZYqgEL5\\\",\\\"S71sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\""));
