...
{
    std::string genesisblockhash = "000001d24f75e56018bc4c667d7d7884a656432332c121c0789e6715ddfa01f2";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (auryn.conf).");
            QMessageBox::warning(this, "auryn Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
