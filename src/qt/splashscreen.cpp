...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("auryn Core");
    ...
    QString copyrightTextauryn = QChar(0xA9) + QString(" 2018-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The auryn Core developers"));
    ...
    //pixPaint.drawText(paddingTop + titleVersionVSpace, versionText);
    ...
    //pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextauryn);
