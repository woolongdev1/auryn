...
// Copyright (c) 2019 The auryn developers
...

{
    ...
    QString windowTitle = tr("auryn Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a auryn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and auryn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAURN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About auryn Core"), this);
    aboutAction->setStatusTip(tr("Show information about auryn Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for auryn"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your auryn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified auryn addresses"));
	...
	showDataFolderAction = new QAction(QIcon(":/icons/browse"), tr("Show Data Folder"), this);
    showDataFolderAction->setStatusTip(tr("Show DataFolder"));
    ...
    openAction->setStatusTip(tr("Open a auryn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the auryn Core help message to get a list with possible auryn command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        ...
        toolbar->setIconSize(QSize(60, 40));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("auryn Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to auryn network", "", count));
}
...
{
    QString strTitle = tr("auryn Core"); // default title
