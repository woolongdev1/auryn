...
cp ../icons/bitcoin_testnet.png auryn_testnet-1024x1024.png
for b in 16 32 128 256 512
do
convert auryn_testnet-1024x1024.png -resize ${b}x${b} icon_${b}x${b}.png
# *Should* be:
# convert auryn-1024x1024.png -unsharp 0 -resize $((b*2))x$((b*2)) icon_${b}x${b}@2x.png
...
cp auryn_testnet-1024x1024.png icon_512x512@2x.png
png2icns bitcoin_testnet.icns icon_16x16.png icon_32x32.png icon_128x128.png icon_256x256.png icon_512x512.png icon_512x512@2x.png
rm -f icon_* auryn-1024x1024.png
