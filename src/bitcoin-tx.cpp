...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("auryn Core auryn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  auryn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded auryn transaction") + "\n" +
                               "  auryn-tx [options] -create [commands]   " + _("Create hex-encoded auryn transaction") + "\n" +
                               "\n";
