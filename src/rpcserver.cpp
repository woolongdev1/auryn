...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"auryn", "masternode", &masternode, true, true, false},
        {"auryn", "listmasternodes", &listmasternodes, true, true, false},
        {"auryn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"auryn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"auryn", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"auryn", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"auryn", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"auryn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"auryn", "masternodedebug", &masternodedebug, true, true, false},
        {"auryn", "startmasternode", &startmasternode, true, true, false},
        {"auryn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"auryn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"auryn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"auryn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"auryn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"auryn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"auryn", "mnbudget", &mnbudget, true, true, false},
        {"auryn", "preparebudget", &preparebudget, true, true, false},
        {"auryn", "submitbudget", &submitbudget, true, true, false},
        {"auryn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"auryn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"auryn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"auryn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"auryn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"auryn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"auryn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"auryn", "checkbudgets", &checkbudgets, true, true, false},
        {"auryn", "mnsync", &mnsync, true, true, false},
        {"auryn", "spork", &spork, true, true, false},
        {"auryn", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> auryn-cli " + methodname + " " + args + "\n";
}
