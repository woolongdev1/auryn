...
extern UniValue setzseed(const UniValue& params, bool fHelp);
extern UniValue getzseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdz(const UniValue& params, bool fHelp);
extern UniValue dzstate(const UniValue& params, bool fHelp);
